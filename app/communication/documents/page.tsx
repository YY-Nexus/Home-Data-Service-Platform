    ...
    <div className="p-6 space-y-6 bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-lg">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-yellow-600">{starredDocuments.length}</div>
        ...
        <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-lg">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-purple-600">{recentDocuments.length}</div>
