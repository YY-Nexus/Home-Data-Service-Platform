    ...
    <div className="p-6 space-y-6 bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-lg">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-green-600">{meetingStats.ongoingMeetings}</div>
        ...
        <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-lg">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-purple-600">{meetingStats.totalParticipants}</div>
        ...
        <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-lg">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-orange-600">{meetingStats.averageDuration}分钟</div>
      ...
      <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-lg">
        <CardHeader>
          <CardTitle className="text-lg">会议安排</CardTitle>
              ...
              <div key={meeting.id} className="p-4 border rounded-lg hover:shadow-md transition-shadow">
                <div className="flex items-start justify-between">
                  ...
                  <div className="flex items-center space-x-2 ml-4">
                    {meeting.status === "ongoing" ? (
                      <Button onClick={() => joinMeeting(meeting.id)} className="bg-green-600 hover:bg-green-700">
