    ...
    <div className="p-6 space-y-6 bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-lg">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-green-600">{actionRequiredCount}</div>
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-start justify-between mb-2">
                            ...
                            <div className="flex items-center space-x-1">
                              ...
                              >
                                <Star
                                  className={`w-4 h-4 ${notification.isStarred ? "text-yellow-500 fill-current" : "text-gray-400"}`}
                                />
                              </Button>
                            </div>
                          </div>
